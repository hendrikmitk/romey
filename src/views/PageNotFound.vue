<template>
  <div class="flex h-screen pt-16">
    <div
      class="flex flex-col px-24 pt-10 pb-2 2xl:pt-16 2xl:px-32 bg-bridal-300"
    >
      <div>
        <div
          @click="$router.push('/')"
        ...
        >
          ...
          <h1 class="font-medium font-montserrat">Home</h1>
        </div>
      </div>
      <div
      ...
      >
        <!-- Error text -->
        <div>
          <div class="mb-2 text-5xl">404 Error</div>
